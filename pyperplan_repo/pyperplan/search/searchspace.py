...
class SearchNode:
    ...
    def __init__(self, state, parent, action, g, id):
        """
...
def make_root_node(initial_state):
    ...
    """
    return SearchNode(initial_state, None, None, 0, id=0)


def make_child_node(parent_node, action, state, id):
    """
    ...
    """
    return SearchNode(state, parent_node, action, parent_node.g + 1 , id=id)
